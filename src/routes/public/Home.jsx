    ...
    ? (
      <main className='app-home'>
        ...
        <p>
          ...
          si se vaciaban los datos del mismo.
    ...
    : (
      <main className='app-home'>
        ...
        <p>Si encuentras alguna falla en la aplicación o quieres dar alguna sugerencia déjanos
          un <Link href='/'>mensaje</Link>, o bien puedes dejar el bug en
          nuestro <a href='https://github.com/ricardo-bohorquez/tiny-task-app/issues' target='blank'>repositorio</a> y
          lo estaremos atendiendo lo más pronto posible.
        </p>
      </main>
      )
}
